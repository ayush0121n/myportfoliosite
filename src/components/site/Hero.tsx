...
export function Hero() {
  ...
  return (
    <section
      ref={ref}
      className="relative min-h-screen flex flex-col justify-end overflow-hidden grain pt-28 pb-10 px-6 md:px-10"
    >
      {/* Floating 3D orb */}
      ...
      <svg
        aria-hidden
        className="absolute inset-0 size-full opacity-[0.06] pointer-events-none"
      >
        <defs>
          <pattern
            id="grid"
