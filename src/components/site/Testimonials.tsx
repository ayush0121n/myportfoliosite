...
const certs = [
  ...
  },
  {
    ...
    title: "Australia Technology Job Simulation",
    date: "Dec 2025",
  },
  {
    issuer: "nasscom FutureSkills",
    title: "Experiential Learning · NSQF L5 (92/100)",
    date: "Mar 2026",
  },
  {
    ...
    <section className="px-6 md:px-10 py-24 md:py-40 border-t border-border">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {certs.map((t, i) => (
          ...
          >
            <span className="text-xs uppercase tracking-[0.25em] text-flame">
              {t.issuer}
            </span>
            <div>
