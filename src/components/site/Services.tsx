...
const skills = [
  {
    ...
    desc: "Production deep learning pipelines, transfer learning, model evaluation.",
    items: [
      "TensorFlow / Keras",
      "CNN · EfficientNetB0",
      "MobileNetV2",
  ...
  },
  {
    ...
    desc: "End-to-end MERN platforms with auth, real-time, and CI/CD.",
    items: [
      "React 18/19 · TS",
      "Node · Express",
      "MongoDB · Mongoose",
  ...
  },
  {
    ...
    desc: "Strong fundamentals across the stack.",
    items: [
      "Python · Java",
      "JavaScript / TS",
      "C++ · SQL",
  ...
  },
  {
    n: "04",
    title: "Cloud & DevOps",
    desc: "Ship to production with CI/CD on managed clouds.",
    items: [
      "Oracle Cloud (OCI)",
      "Vercel · Render",
      "Git / GitHub",
    ...
    >
      <div className="flex items-end justify-between mb-16">
        <h2 className="font-display text-[clamp(3rem,8vw,9rem)]">
          What I <br />
          <span className="text-flame italic">build with.</span>
        </h2>
          ...
          return (
            <div key={s.n} className="border-b border-border">
              ...
              >
                ...
                <h3 className="flex-1 font-display text-3xl md:text-6xl group-hover:text-flame transition-colors">
                  {s.title}
                </h3>
                <motion.span
                  animate={{ rotate: isOpen ? 45 : 0 }}
                  className="text-3xl md:text-5xl text-flame"
                >
                  +
                </motion.span>
              </button>
                  ...
                  <ul className="grid grid-cols-2 gap-2 text-sm uppercase tracking-[0.15em] text-muted-foreground">
                    {s.items.map((it) => (
                      <li key={it} className="flex items-center gap-2">
                        <span className="size-1 bg-flame rounded-full" /> {it}
                      </li>
                    ))}
                  </ul>
                </div>
